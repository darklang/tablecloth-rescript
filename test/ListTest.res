...
let suite = suite("List", () => {
  ...
  describe("singleton", () => {
    ...
    test("returns array singleton of int arg", () =>
      expect(List.singleton(1234)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("returns array singleton of string arg", () =>
      expect(List.singleton("hello")) |> toEqual(
        {
          open Eq
          list(string)
        },
  ...
  describe("repeat", () => {
    test("returns empty list from repeat arg 0", () =>
      expect(List.repeat(~times=0, 7)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("returns empty list from negative repeat arg -10", () =>
      expect(List.repeat(~times=-10, 7)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("returns list of char 'a' repeated 5 times", () =>
      expect(List.repeat(~times=5, 'a')) |> toEqual(
        {
          open Eq
          list(char)
        },
  ...
  describe("range", () => {
    ...
    test("with to and from", () =>
      expect(List.range(~from=2, 5)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("with negative", () =>
      expect(List.range(~from=-2, 2)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("returns empty with count down", () =>
      expect(List.range(~from=5, 2)) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("initalize", () => {
    test("with identity", () =>
      expect(List.initialize(4, ~f=index => index)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("with math", () =>
      expect(List.initialize(4, ~f=index => index * index)) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("fromArray", () => {
    ...
    test("from string", () =>
      expect(List.fromArray(['h', 'e', 'l', 'l', 'o'])) |> toEqual(
        {
          open Eq
          list(char)
        },
    ...
    test("with int", () =>
      expect(List.fromArray([-1, 3, 2, 7])) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("head", () => {
    ...
    test("with int", () =>
      expect(List.head(list{-3, 2, 3, 4, 6})) |> toEqual(
        {
          open Eq
          option(int)
        },
  ...
  describe("cons", () => {
    test("from empty", () =>
      expect(List.cons(list{}, 1)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("with int", () =>
      expect(List.cons(list{2, 3, 4}, 1)) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("filterWithIndex", () => {
    test("returns elements if index is greater than 1", () =>
      expect(filterWithIndex(list{2, 99, 0, 3}, ~f=(i, _) => i > 1)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("empty list", () =>
      expect(filterWithIndex(list{}, ~f=(i, _) => i > 1)) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("filter", () => {
    test("normal", () =>
      expect(filter(~f=Int.isEven, list{2, 4, 6, 7, 8, 9})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("filter none", () =>
      expect(filter(~f=Int.isEven, list{5, 7, 9})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("filter all", () =>
      expect(filter(~f=Int.isEven, list{2, 4, 6})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("dropWhile", () => {
    test("drops item from list if isEven, returns list of only odd items", () =>
      expect(dropWhile(~f=Int.isEven, list{2, 4, 6, 7, 8, 9})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test(
      ...
      () =>
        expect(dropWhile(~f=Int.isEven, list{3, 4, 7, 8, 9})) |> toEqual(
          {
            open Eq
            list(int)
          },
    ...
    test("drops all because all items are even, returns empty list", () =>
      expect(dropWhile(~f=Int.isEven, list{2, 4, 6, 8})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("drops none because all items are odd, returns list without changes", () =>
      expect(dropWhile(~f=Int.isEven, list{1, 3, 5, 7})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("take", () => {
    test("normal", () =>
      expect(take(list{1, 2, 3}, ~count=2)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("from an empty list", () =>
      expect(take(list{}, ~count=2)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("overflow", () =>
      expect(take(list{1, 2, 3, 4}, ~count=8)) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("overflow", () =>
      expect(take(list{1, 2, 3, 4}, ~count=-1)) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("takeWhile", () => {
    test("takes items until isEven returns false, returns list of items until first odd item", () =>
      expect(takeWhile(~f=Int.isEven, list{2, 4, 6, 7, 8, 9})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test(
      ...
      () =>
        expect(takeWhile(~f=Int.isEven, list{2, 6, 7, 15, 10, 9, 8})) |> toEqual(
          {
            open Eq
            list(int)
          },
    ...
    test("takes no items as first item returns false to isEven, returns empty list", () =>
      expect(takeWhile(~f=Int.isEven, list{1, 6, 7, 15, 10, 9, 8})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("takes all items as all items return true to isEven, returns list without changes", () =>
      expect(takeWhile(~f=Int.isEven, list{2, 4, 6})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("returns empty list from arg empty list", () =>
      expect(takeWhile(~f=Int.isEven, list{})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("takes no items as all items return false to isEven, returns empty list", () =>
      expect(takeWhile(~f=Int.isEven, list{1, 3, 5})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("includes", () => {
    test("includes int", () =>
      expect(includes(list{1, 3, 5, 7}, 3, ~equal=Int.equal)) |> toEqual(Eq.bool, true)
    )
    test("does not includes int", () =>
      expect(includes(list{1, 3, 5, 7}, 4, ~equal=Int.equal)) |> toEqual(Eq.bool, false)
    )
    test("empty list", () =>
      expect(includes(list{}, 5, ~equal=Int.equal)) |> toEqual(Eq.bool, false)
    )
  })
  ...
  describe("map2", () => {
    ...
    test("map2 with lists of different lengths", () =>
      expect(map2(~f=\"+", list{1, 2, 3}, list{1, 2})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("map3", () => {
    test("map3 empty lists", () =>
      expect(map3(~f=(x, y, z) => x + y + z, list{}, list{}, list{})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("map3 one element", () =>
      expect(map3(~f=(x, y, z) => x + y + z, list{1}, list{1}, list{1})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("map3 two elements", () =>
      expect(map3(~f=(x, y, z) => x + y + z, list{1, 2}, list{1, 2}, list{1, 2})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("map3 elements on lists of different lengths", () =>
      expect(map3(~f=(x, y, z) => x + y + z, list{1, 2, 3}, list{1, 2, 3}, list{1, 2})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("flatMap", () => {
    test("normal", () =>
      expect(flatMap(~f=x => list{x, x}, list{1, 2, 3})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("on an empty list", () =>
      expect(flatMap(~f=x => list{x, x}, list{})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("deeper list", () =>
      expect(flatMap(~f=x => append(x, list{1}), list{list{1, 1}, list{2}, list{3}})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("groupWhile", () => {
    test("empty list", () =>
      expect(groupWhile(~f=String.equal, list{})) |> toEqual(
        {
          open Eq
          list(list(string))
        },
    ...
    test("normal char", () =>
      expect(groupWhile(~f=\"<>", list{"a", "b", "b", "a", "a", "a", "b", "a"})) |> toEqual(
        {
          open Eq
          list(list(string))
        },
    ...
    test("normal int", () =>
      expect(
        ...
        list{list{2, 4, 6}, list{5, 3, 1}, list{8}, list{7, 9}},
      )
    )
  })
  ...
  describe("join", () => {
    test("normal", () =>
      expect(join(list{"Ant", "Bat", "Cat"}, ~sep=", ")) |> toEqual(Eq.string, "Ant, Bat, Cat")
    )
    test("empty list", () => expect(join(list{}, ~sep=", ")) |> toEqual(Eq.string, ""))
  })
  ...
  describe("sort", () => {
    test("empty list", () =>
      expect(sort(~compare=Int.compare, list{})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("one element", () =>
      expect(sort(~compare=Int.compare, list{5})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("multiple elements", () =>
      expect(sort(~compare=Int.compare, list{5, 6, 8, 3, 6})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("sortBy", () => {
    test("empty list", () =>
      expect(sortBy(~f=x => x, list{})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("one element", () =>
      expect(sortBy(~f=x => x, list{5})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("sort records", () => {
      let s1 = {AlcoJest.Student.id: 200, AlcoJest.Student.name: "Syd"}

      let s2 = {AlcoJest.Student.id: 53, AlcoJest.Student.name: "Bill"}

      let s3 = {AlcoJest.Student.id: 30, AlcoJest.Student.name: "Carmen"}

      let studentList = list{s1, s2, s3}
      let sortedRecs = sortBy(~f=x => x.AlcoJest.Student.id, studentList)

      expect(sortedRecs) |> toEqual(
        {
          open Eq
          list(student)
        },
    ...
    test("empty list", () =>
      expect(sortBy(~f=x => x * x, list{3, 2, 5, -2, 4})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("uniqueBy", () => {
    test("int self", () =>
      expect(uniqueBy(~f=element => string_of_int(element), list{1, 3, 4, 3, 7, 7, 6})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("minimumBy", () => {
    test("minimumBy non-empty list", () =>
      expect(List.minimumBy(~f=x => mod(x, 12), list{7, 9, 15, 10, 3, 22})) |> toEqual(
        {
          open Eq
          option(int)
        },
    ...
    test("minimumBy empty list", () =>
      expect(List.minimumBy(~f=x => mod(x, 12), list{})) |> toEqual(
        {
          open Eq
          option(int)
        },
  ...
  describe("maximumBy", () => {
    test("maximumBy non-empty list", () =>
      expect(List.maximumBy(~f=x => mod(x, 12), list{7, 9, 15, 10, 3, 22})) |> toEqual(
        {
          open Eq
          option(int)
        },
    ...
    test("maximumBy empty list", () =>
      expect(List.maximumBy(~f=x => mod(x, 12), list{})) |> toEqual(
        {
          open Eq
          option(int)
        },
  ...
  describe("extent", () => {
    test("return tuple of min and max", () =>
      expect(extent(list{7, 5, 8, 6}, ~compare=Int.compare)) |> toEqual(
        {
          open Eq
          option(pair(int, int))
        },
    ...
    test("return tuple of min and max from single element list", () =>
      expect(extent(list{5}, ~compare=Int.compare)) |> toEqual(
        {
          open Eq
          option(pair(int, int))
        },
    ...
    test("return tuple of min and max from empty list", () =>
      expect(extent(list{}, ~compare=Int.compare)) |> toEqual(
        {
          open Eq
          option(pair(int, int))
        },
  ...
  describe("sum", () => {
    test("sum of empty", () => expect(sum(list{}, module(Int))) |> toEqual(Eq.int, 0))
    test("sum of ints", () => expect(sum(list{1, 1, 2, 3}, module(Int))) |> toEqual(Eq.int, 7))
  ...
  describe("map", () => {
    test("map sqrt", () =>
      expect(map(~f=Float.squareRoot, list{1.0, 4.0, 9.0})) |> toEqual(
        {
          open Eq
          list(float)
        },
    ...
    test("list char", () =>
      expect(
        ...
        list{list{'h', 'i'}, list{'h', 'a'}, list{'h', 'o', 'p'}},
      )
    )
    test("empty list", () =>
      expect(map(~f=Float.squareRoot, list{})) |> toEqual(
        {
          open Eq
          list(float)
        },
  ...
  describe("find", () => {
    test("find first of 2 matches", () =>
      expect(List.find(~f=Int.isEven, list{1, 3, 4, 8})) |> toEqual(
        {
          open Eq
          option(int)
        },
    ...
    test("find 0 of 0 matches", () =>
      expect(List.find(~f=Int.isOdd, list{0, 2, 4, 8})) |> toEqual(
        {
          open Eq
          option(int)
        },
    ...
    test("empty list", () =>
      expect(List.find(~f=Int.isEven, list{})) |> toEqual(
        {
          open Eq
          option(int)
        },
  ...
  describe("isEmpty", () => {
    test("from empty list", () => expect(isEmpty(List.empty)) |> toEqual(Eq.bool, true))
    test("from empty list", () => expect(isEmpty(list{})) |> toEqual(Eq.bool, true))
    test("from list with elements", () =>
      expect(isEmpty(list{1, -4, 5, 6})) |> toEqual(Eq.bool, false)
    )
  })

  describe("length", () => {
    test("from empty list", () => expect(length(list{})) |> toEqual(Eq.int, 0))
    test("from list with elements", () => expect(length(list{1, -4, 5, 6})) |> toEqual(Eq.int, 4))
  })

  describe("any", () => {
    test("from empty list", () => expect(any(list{}, ~f=Int.isEven)) |> toEqual(Eq.bool, false))
    test("from even list", () => expect(any(list{2, 3}, ~f=Int.isEven)) |> toEqual(Eq.bool, true))
    test("from odd list", () => expect(any(list{1, 3}, ~f=Int.isEven)) |> toEqual(Eq.bool, false))
  })
  describe("all", () => {
    test("from empty list", () => expect(all(list{}, ~f=Int.isEven)) |> toEqual(Eq.bool, true))
    test("from even list", () => expect(all(list{2, 3}, ~f=Int.isEven)) |> toEqual(Eq.bool, false))
    test("from all even list", () =>
      expect(all(list{2, 4}, ~f=Int.isEven)) |> toEqual(Eq.bool, true)
    )
    test("from odd list", () => expect(any(list{1, 3}, ~f=Int.isEven)) |> toEqual(Eq.bool, false))
  })

  describe("count", () => {
    test("empty list", () => expect(count(list{}, ~f=Int.isEven)) |> toEqual(Eq.int, 0))

    test("one even element", () => expect(count(list{2, 3}, ~f=Int.isEven)) |> toEqual(Eq.int, 1))
    test("all even elements", () => expect(count(list{2, 4}, ~f=Int.isEven)) |> toEqual(Eq.int, 2))
  })
  ...
  describe("splitAt", () => {
    ...
    test("negative", () =>
      expect(splitAt(~index=-1, list{1, 3, 5})) |> toEqual(
        {
          open Eq
          pair(list(int), list(int))
        },
  ...
  describe("getAt", () => {
    test("empty list", () =>
      expect(List.getAt(list{}, ~index=2)) |> toEqual(
        {
          open Eq
          option(int)
        },
    ...
    test("normal", () =>
      expect(List.getAt(list{1, 2, 3}, ~index=1)) |> toEqual(
        {
          open Eq
          option(int)
        },
    ...
    test("overflow", () =>
      expect(List.getAt(list{1, 2, 3}, ~index=100)) |> toEqual(
        {
          open Eq
          option(int)
        },
    ...
    test("negative index", () =>
      expect(List.getAt(list{1, 2, 3}, ~index=-2)) |> toEqual(
        {
          open Eq
          option(int)
        },
  ...
  describe("insertAt", () => {
    ...
    test("after end of list", () =>
      expect(insertAt(~index=4, ~value=2, list{1, 3})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("#216", () =>
      expect(insertAt(~index=5, ~value=1, list{0, 2, 3, 4, 5, 6, 7, 8, 9})) |> toEqual(
        {
          open Eq
          list(int)
        },
        list{0, 2, 3, 4, 5, 1, 6, 7, 8, 9},
      )
    )
    test("doc 1", () =>
      expect(insertAt(~index=2, ~value=999, list{100, 101, 102, 103})) |> toEqual(
        {
          open Eq
          list(int)
        },
        list{100, 101, 999, 102, 103},
      )
    )
    test("doc 2", () =>
      expect(insertAt(~index=0, ~value=999, list{100, 101, 102, 103})) |> toEqual(
        {
          open Eq
          list(int)
        },
        list{999, 100, 101, 102, 103},
      )
    )
    test("doc 3", () =>
      expect(insertAt(~index=4, ~value=999, list{100, 101, 102, 103})) |> toEqual(
        {
          open Eq
          list(int)
        },
        list{100, 101, 102, 103, 999},
      )
    )
    test("doc 4", () =>
      expect(insertAt(~index=-1, ~value=999, list{100, 101, 102, 103})) |> toEqual(
        {
          open Eq
          list(int)
        },
    ...
    test("doc 5", () =>
      expect(insertAt(~index=5, ~value=999, list{100, 101, 102, 103})) |> toEqual(
        {
          open Eq
          list(int)
        },
  ...
  describe("zip", () => {
    test("zip num and string", () =>
      expect(zip(list{1, 2, 3, 4, 5}, list{"Dog", "Eagle", "Ferret"})) |> toEqual(
        {
          open Eq
    ...
    test("zip num and empty", () =>
      expect(zip(list{1, 2, 3, 4, 5}, list{})) |> toEqual(
        {
          open Eq
          list(pair(int, int))
        },
  ...
  describe("chunksOf", () => {
    test("empty list", () =>
      expect(chunksOf(~size=2, list{})) |> toEqual(
        {
          open Eq
          list(list(int))
        },
  ...
  describe("toArray", () => {
    test("returns an array of int", () =>
      expect(toArray(list{2, 4, 6, 8})) |> toEqual(
        {
          open Eq
          array(int)
        },
    ...
    test("returns an array of char", () =>
      expect(toArray(list{'h', 'i'})) |> toEqual(
        {
          open Eq
          array(char)
        },
  ...
  describe("equal", () => {
    test("normal int", () =>
      expect(equal(list{2, 5, 6, 11}, list{2, 5, 6, 11}, Int.equal)) |> toEqual(Eq.bool, true)
    )
    test("normal int", () =>
      expect(equal(list{2, 5, -6, 11}, list{2, 5, 6, 11}, Int.equal)) |> toEqual(Eq.bool, false)
    )
    test("normal string", () =>
      expect(
        equal(list{"hi", "hello", "hey"}, list{"hi", "hello", "hey"}, String.equal),
  ...
  describe("compare", () => {
    test("normal int", () =>
      expect(compare(list{2, 5, 6, 11}, list{2, 5, 6, 11}, Int.compare)) |> toEqual(Eq.int, 0)
    )
    test("normal int with different element", () =>
      expect(compare(list{2, 5, -6, 11}, list{2, 5, 6, 11}, Int.compare)) |> toEqual(Eq.int, -1)
    )
    test("normal int with shorter and longer array", () =>
      expect(compare(list{2, 5, 6, 11}, list{2, 5, 6}, Int.compare)) |> toEqual(Eq.int, 1)
    )
    test("normal string", () =>
      expect(
